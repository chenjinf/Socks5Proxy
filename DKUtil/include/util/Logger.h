...
#define LOG_DEBUGW Logger::getInstance()->getHelperW(LOGGER_COMPONENT, Logger::Debug, __FUNCTION__, NULL, 0)
#define LOG_INFOW  Logger::getInstance()->getHelperW(LOGGER_COMPONENT, Logger::Info,  __FUNCTION__, NULL, 0)
#define LOG_WARNW  Logger::getInstance()->getHelperW(LOGGER_COMPONENT, Logger::Warn,  __FUNCTION__, NULL, 0)
#define LOG_ERRORW Logger::getInstance()->getHelperW(LOGGER_COMPONENT, Logger::Error, __FUNCTION__, NULL, 0)
#define LOG_FATALW Logger::getInstance()->getHelperW(LOGGER_COMPONENT, Logger::Fatal, __FUNCTION__, __FILE__, __LINE__)
...
public:
	...
	class HelperW {
	public:
		HelperW(const char* component, Level, const char* className, const char* fileName, int line);
	...
	static  Logger* getInstance();
	 ...
	 HelperW getHelperW(const char* component, Logger::Level, const char* className, const char* filename, int line);
